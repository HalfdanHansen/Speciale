...
plt.suptitle('Training Results For Methods on conv500 and CIFAR-10, rank 1', fontsize=20)
...
plt.savefig('2705_Plot_all_methods_on_cifar10_conv500_3D.pgf')
plt.show()
...
plt.suptitle('Training Results For Methods on conv500 and CIFAR-10, rank 8', fontsize=20)
...
plt.savefig('2705_Plot_all_methods_on_cifar10_conv500_4D.pgf')
plt.show()
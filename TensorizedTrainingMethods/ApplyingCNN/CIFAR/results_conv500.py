...
normal = pd.read_csv (r'0305_conv500normalCIFAR10.csv',header=None,index_col=None)
PARAFAC3D_R1 = pd.read_csv (r'0305_conv500PARAFAC3DCIFAR10.csv',header=None,index_col=None)
ATCD3D_R1 = pd.read_csv (r'0305_conv500ATCD3DCIFAR10.csv',header=None,index_col=None)
PARAFAC4D_R1 = pd.read_csv (r'0305_conv500PARAFAC4DCIFAR10.csv',header=None,index_col=None)
PARAFAC4D_R8 = pd.read_csv (r'0305_conv500PARAFAC4DCIFAR10_rank8.csv',header=None,index_col=None)
Tucker24D_R1 = pd.read_csv (r'0305_conv500Tucker2114DCIFAR10.csv',header=None,index_col=None)
Tucker24D_R8 = pd.read_csv (r'0305_conv500Tucker2884DCIFAR10.csv',header=None,index_col=None)
ATCD4D_R1 = pd.read_csv (r'0305_conv500ATCD4DCIFAR10.csv',header=None,index_col=None)
ATCD4D_R8 = pd.read_csv (r'0305_conv500ATCD4DCIFAR10_rank8.csv',header=None,index_col=None)
...
ax1.plot(epoch, list(normal[0][0:50]), 'r-',
         epoch, list(PARAFAC3D_R1[0][0:50]), 'y--',
  #       epoch, list(ATCD3D_R1[0][0:50]), 'b--',
         epoch, list(PARAFAC4D_R1[0][0:50]), 'm:',
         epoch, list(PARAFAC4D_R8[0][0:50]), 'm--',
         epoch, list(Tucker24D_R1[0][0:50]), 'g--',
         epoch, list(Tucker24D_R8[0][0:50]), 'g:',
         epoch, list(ATCD4D_R1[0][0:50]), 'k--',
         epoch, list(ATCD4D_R8[0][0:50]), 'k:')
...
#'ATCD3D R1'
ax1.legend(['Normal', 'PARAFAC3D R1' ,'PARAFAC4D R1','PARAFAC4D R8','Tucker24D R1','Tucker24D R8', 'ATCD4D R1', 'ATCD4D R8'], loc = 'lower right')

if __name__ == '__main__':    
    ...
    pd.concat([save_train,save_test,save_loss],axis = 0).to_csv('0905_conv500PARAFAC3DCIFAR10.csv',index=False,header=False)

     #Save model
    torch.save(net, "0905_conv500PARAFAC3DCIFAR10")
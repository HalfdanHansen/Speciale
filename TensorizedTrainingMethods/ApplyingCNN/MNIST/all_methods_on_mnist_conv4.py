...
pd.concat([save_train,save_valid,save_test], axis = 0).to_csv('MNIST_conv4_normal.csv',index=False,header=False)


#Save model
#torch.save(netNormal, "2905_conv4normalMNIST100")
...
pd.concat([save_train,save_valid,save_test], axis = 0).to_csv('MNIST_conv4_CD4D.csv',index=False,header=False)

#Save model
#torch.save(netD4DD, "2905_conv4D4DDMNIST100")
...
pd.concat([save_train,save_valid,save_test], axis = 0).to_csv('MNIST_conv4_CD3D.csv',index=False,header=False)
...
pd.concat([save_train,save_valid,save_test], axis = 0).to_csv('MNIST_conv4_BAF4D.csv',index=False,header=False)

#Save model
#torch.save(netBAF4D, "2905_conv4BAF4DMNIST100")
...
pd.concat([save_train,save_valid,save_test], axis = 0).to_csv('MNIST_conv4_BAF3D.csv',index=False,header=False)
...
pd.concat([save_train,save_valid,save_test], axis = 0).to_csv('MNIST_conv4_ATCD3D.csv',index=False,header=False)
...
pd.concat([save_train,save_valid,save_test], axis = 0).to_csv('MNIST_conv4_ATCD4D.csv',index=False,header=False)
    
    #Save model
    #torch.save(netATDC4D, "2905_conv4ATDC4DMNIST100")
...
pd.concat([save_train,save_valid,save_test], axis = 0).to_csv('2905_MNIST100_conv4_4D2methods.csv',index=False,header=False)
"""

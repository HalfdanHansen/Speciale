if __name__ == '__main__':    
    ...
    pd.concat([save_train,save_test,save_loss],axis = 0).to_csv('0905_webNetPARAFAC3DCIFAR100.csv',index=False,header=False)

    #Save model
    torch.save(net, "0905_webNetPARAFAC3DCIFAR100")
if __name__ == '__main__':
    ...
    lName = ['classifier[1]', 'classifier[5]', 'classifier[9]']
    ...
    pd.concat([save_train,save_test,save_loss],axis = 0).to_csv('17_05_Papernet2True3DATCD_CIFAR10.csv',index=False,header=False)
    
    torch.save(net,"Papernet2True3DATCD")

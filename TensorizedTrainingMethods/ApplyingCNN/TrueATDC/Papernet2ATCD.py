if __name__ == '__main__':
    ...
    filternumbers = [64, 64, 144, 144, 256, 256]
    ...
    lNames = ['classifier[1]', 'classifier[5]', 'classifier[9]']
    
    net = deepcopy(papernet2True)
    net.to(device)
    ...
    pd.concat([save_train,save_test,save_loss],axis = 0).to_csv('17_05_Papernet2True3DATCDSharedWeights_CIFAR10.csv',index=False,header=False)
    
    torch.save(net,"Papernet2True3DATCDSharedWeights")
